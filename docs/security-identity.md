...
2. The Function App uses this identity to obtain access tokens for any Azure service that supports Azure AD authentication — Storage, Cosmos DB, Service Bus, and others.
